        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-purple-200 mb-6 max-w-md">
              Empowering students with industry-relevant skills and connecting them 
              with top companies for successful career placements.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-purple-700 rounded-full flex items-center justify-center hover:bg-purple-600 transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-purple-200 hover:text-white transition-colors duration-300">Home</Link></li>
              <li><Link to="/internships" className="text-purple-200 hover:text-white transition-colors duration-300">Internships</Link></li>
              <li><Link to="/team" className="text-purple-200 hover:text-white transition-colors duration-300">Team</Link></li>
              <li><Link to="/about" className="text-purple-200 hover:text-white transition-colors duration-300">About Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/enquiry" className="text-purple-200 hover:text-white transition-colors duration-300">Enquiry</Link></li>
